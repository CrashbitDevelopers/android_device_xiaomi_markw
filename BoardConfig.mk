...
# Qualcomm LLVM Compiler instrucciones (Desactivado)
# SDCLANG := true
# SDCLANG_PATH := $(ANDROID_BUILD_TOP)/prebuilts/clang/linux-x86/host/sdclang-3.8.8/bin
...
TARGET_KERNEL_CONFIG := lineage_markw_defconfig
TARGET_KERNEL_SOURCE := kernel/xiaomi/markw
TARGET_KERNEL_CROSS_COMPILE_PREFIX := aarch64-linux-android-
KERNEL_TOOLCHAIN := $(ANDROID_BUILD_TOP)/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-5.4.1/bin
